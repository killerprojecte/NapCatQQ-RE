...
const FrameworkBaseConfigPlugin: PluginOption[] = [
  autoIncludeTSPlugin({
    entries: [
      {
        entry: "napcat.ts",
        dir: path.resolve(__dirname, "../napcat-core/protocol"),
      },
      {
        entry: "napcat.ts",
        dir: path.resolve(__dirname, "../napcat-onebot/action/test"),
      },
    ],
  }),
  ...
  cp({
    targets: [
      ...
      {
        src: "../napcat-webui-frontend/dist/",
        dest: "dist/static/",
        flatten: false,
      },
    ...
    build: {
      ...
      lib: {
        entry: {
          ...
          "worker/conoutSocketWorker": path.resolve(
            __dirname,
            "../napcat-pty/worker/conoutSocketWorker.ts",
          ),
        },
        formats: ["es"],
